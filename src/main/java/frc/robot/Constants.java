...
public final class Constants {
  ...
  public static final class RollerConstants{
    ...
    public static final int ROLLOR_MOTOR_CURRENT_LIMIT = 60;
    public static final double ROLLER_MOTOR_VOLTAGE_COMP= 10;
    public static final double ROLLER_SLOW_SPEEDOUT_IN_RADPERSEC = 25;
    public static final double ROLLER_FAST_SPEEDOUT_IN_RADPERSEC  = 100;
    public static final double ROLLER_SPEEDIN = -25;
  }
