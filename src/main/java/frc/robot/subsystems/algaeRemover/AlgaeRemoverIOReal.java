...
public class AlgaeRemoverIOReal implements AlgaeRemoverIO {
  ...
  public AlgaeRemoverIOReal(int armId,int rollerId, String bus) {
  ...
  public void rollerRun(double positionInRotations) {
  ...
  public void armRun(double positionInRotations) {
    // var request = positionControl.withPosition(positionInRotations);
    // motor.setControl(request);
