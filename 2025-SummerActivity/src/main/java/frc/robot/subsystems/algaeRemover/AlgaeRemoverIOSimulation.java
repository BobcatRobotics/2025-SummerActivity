...
public class AlgaeRemoverIOSimulation implements AlgaeRemoverIO {
  ...
  public AlgaeRemoverIOSimulation() {
  ...
  public void setPosition(double position) {
    algaeRemoverPositionMotor.setControl(positionMotorRequest.withPosition(position));
  }
